...
const Facebook = React.createClass({
  ...
  render() {
    return (
      <svg viewBox="0 0 12 12" preserveAspectRatio="xMidYMid meet" className="svg-share-icon svg-share-icon-facebook">
...
const Twitter = React.createClass({
  ...
  render() {
    return (
      <svg viewBox="0 0 12 12" preserveAspectRatio="xMidYMid meet" className="svg-share-icon svg-share-icon-twitter">
...
const Google = React.createClass({
  ...
  render() {
    return (
      <svg viewBox="0 0 12 12" preserveAspectRatio="xMidYMid meet" className="svg-share-icon svg-share-icon-google">
